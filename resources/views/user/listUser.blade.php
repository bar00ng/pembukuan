...
<nav aria-label="breadcrumb" class='breadcrumb-header text-right'>
    <ol class="breadcrumb">
        <li class="breadcrumb-item active"><a href="{{ route('user.list') }}">Daftar Kasir</a></li>
    </ol>
</nav>
@endsection
        ...
        <div class="card-body">
            <table class='table table-striped' id="table1">
                ...
                @if ($users->isEmpty())
                    <tbody>
                        <tr>
                            <td colspan="10" class="p-5 italic text-center">Daftar User Kosong</td>
                        </tr>
                    </tbody>
                @else
                    <tbody>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>
                                                            ...
                                                            <b>{{$user['name'] }}</b> dari daftar user/kasir?
                                                        </p>
                                                    </div>

...
<nav aria-label="breadcrumb" class='breadcrumb-header text-right'>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="#">Edit Pengeluaran</a></li>
    </ol>
</nav>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    @if (session('editDaftarPengeluaran'.$data['id']))
                                        @foreach (session('editDaftarPengeluaran'.$data['id']) as $id => $details)
                                            @php
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <a href={{ route('addBarang', [
                                                                                            'id' => $product['id'],
                                                                                            'sessionName' => 'editDaftarPengeluaran'.$data['id'],
                                                                                            'type' => 'income',
                                                                                        ]) }}
    ...
    <div class="row match-height">
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" action={{ route('outcome.patch',['id'=>$data['id']]) }} method="POST">
                            @method('PATCH')
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="0" name="hargaModal"
                                                id="harga-modal" value={{ session('editDaftarPengeluaran'.$data['id']) ? $total : $data['hargaModal'] }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="" for="" {{ $data['status'] == 1 ? 'checked' : ''}}>
                                            Lunas
                                        </label>
                                    </div>
                                    <div class="form-check">
...
<script>
    $(".remove-barang").click(function(e) {
        ...
        if (confirm("Yakin ingin menghapus item?")) {
            $.ajax({
            url: "{{ route('removeBarang', 'editDaftarPengeluaran'.$data['id']) }}",
                method: "DELETE",
                data: {
                    _token: '{{ csrf_token() }}',
    ...
    $(".update-barang").change(function(e) {
        ...
        var ele = $(this);
        $.ajax({
            url: "{{ route('editBarang',['sessionName' => 'editDaftarPengeluaran'.$data['id'], 'type' => 'outcome']) }}",
            method: "patch",
            data: {
                _token: '{{ csrf_token() }}',
                id: ele.parents("tr").attr("data-id"),

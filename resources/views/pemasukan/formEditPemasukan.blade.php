...
<nav aria-label="breadcrumb" class='breadcrumb-header text-right'>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="#">Edit Pemasukan</a></li>
    </ol>
</nav>
@endsection
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <a href={{ route('addBarang', [
                                                                                            'id' => $product['id'],
                                                                                            'sessionName' => 'daftarBarang'.$data['id'],
                                                                                            'type' => 'income',
                                                                                        ]) }}
    ...
    <div class="row match-height">
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" action={{ route('income.patch',['id'=>$data['id']]) }} method="POST">
                            @method('patch')
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="0"
                                                ...
                                                value={{ session('daftarBarang'.$data['id']) ? $total : $data['totalPemasukan'] }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="0" name="hargaModal"
                                            id="harga-modal" value={{ session('daftarBarang'.$data['id']) ? $modal : $data['hargaModal'] }}>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="0" name="keuntungan"
                                            id="keuntungan" value={{ session('daftarBarang'.$data['id']) ? $keuntungan : $data['keuntungan'] }} readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="" type="radio" name="status" id="" selected value=1 {{ $data['status'] == 1 ? 'checked' : ''}}>
                                        <label class="" for="">
                                            Lunas
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="" type="radio" name="status" id="" value=0 {{ $data['status'] != 1 ? 'checked' : ''}}>
                                        <label class="" for="">
                                            Tidak Lunas
                                        </label>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="" placeholder="Opsional" name="description" rows="3">{{$data['description'] ? $data['description']: ''}}</textarea>
                                </div>
                            </div>

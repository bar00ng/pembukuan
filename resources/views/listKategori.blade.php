...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class='breadcrumb-header text-right'>
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="{{ route('category.list') }}">Kategori</a></li>
        </ol>
    </nav>
@endsection
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="categoryName" class="form-control"
                                                        name="categoryName" placeholder="Nama Kategori" required>
                                                </div>
                                            </div>
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="buttons">
                                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit-modal-{{$category['id']}}">Edit</button>
                                                <div class="modal fade" id="edit-modal-{{ $category['id'] }}" tabindex="-1"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    <label for="categoryName">Nama Kategori</label>
                                                                                    <input type="text" id="categoryName" class="form-control"
                                                                                        name="categoryName" placeholder="Nama Kategori"  value={{ $category['categoryName'] }} required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 d-flex justify-content-end">
                                                                                <button type="submit" class="btn btn-primary me-1 mb-1">Submit</button>
                                                ...
                                                <button type="button" data-bs-toggle="modal"
                                                    data-bs-target="#delete-modal-{{ $category['id'] }}"
                                                    class="btn btn-danger btn-sm">Delete</button>
                                                <div class="modal fade" id="delete-modal-{{ $category['id'] }}" tabindex="-1"
                                                    role="dialog" aria-labelledby="exampleModalCenterTitle"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                                                        role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>
                                                                    ...
                                                                    <b>{{ $category['categoryName'] }}</b> dari daftar
                                                                    kategori
                                                                    barang?
                                                                </p>
                                                            </div>

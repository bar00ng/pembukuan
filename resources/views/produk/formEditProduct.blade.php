            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action={{ route('product.patch', ['id' => $product['id']]) }} method="POST">
                                @method('PATCH')
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id=""
                                                ...
                                                value={{ $errors->first('productName')? old('productName') : $product['productName'] }}>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="productPrice"
                                            ...
                                            placeholder="0" value={{ $errors->first('productPrice')? old('productPrice') : $product['productPrice'] }} required>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id=""
                                            ...
                                            placeholder="0" name="productModal" value={{ $errors->first('productModal')? old('productModal') : $product['productModal'] }}>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="0" id=""
                                            ...
                                            name="inStock" placeholder="0" required value={{ $errors->first('inStock')? old('inStock') : $product['inStock'] }}>

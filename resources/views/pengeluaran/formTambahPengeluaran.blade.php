    ...
    <div class="row match-height">
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" action={{ route('outcome.store') }} method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="0" name="hargaModal"
                                                id="harga-modal" value={{ session('daftarPengeluaran') ? $modal : 0 }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $(".update-barang").change(function(e) {
        ...
        var ele = $(this);
        $.ajax({
            url: "{{ route('editBarang',['sessionName' => 'daftarPengeluaran', 'type' => 'outcome']) }}",
            method: "patch",
            data: {
                _token: '{{ csrf_token() }}',
                id: ele.parents("tr").attr("data-id"),
